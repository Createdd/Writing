...
Linear regression tries to fit points to a line generated by an algorithm. This optimized line is a model that is capable of predicting values for certain input values and can be plotted.
