...
Check out my [Github Repo](https://github.com/DDCreationStudios/fetchingReactRedux) to see the other files as well. Be sure to understand basic React to utilize the power Redux in my example. 
